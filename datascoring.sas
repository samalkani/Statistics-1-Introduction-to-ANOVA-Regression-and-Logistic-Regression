...
_LP0 = _LP0 + (13659.2681053911) * _1_1;
*** Effect: Overall_Cond2;
_LP0 = _LP0 + (8996.61802000387) * _2_0;
_LP0 = _LP0 + (15909.0589761633) * _2_1;
*** Effect: Fireplaces;
_LP0 = _LP0 + (9716.20592451275) * _3_0;
_LP0 = _LP0 + (7235.66161869981) * _3_1;
*** Effect: Heating_QC;
_LP0 = _LP0 + (-11667.6811780935) * _7_0;
_LP0 = _LP0 + (-3178.91839042388) * _7_1;
_LP0 = _LP0 + (-6689.2471259941) * _7_2;
*** Effect: Masonry_Veneer;
_LP0 = _LP0 + (-3369.65262228733) * _8_0;
*** Effect: Lot_Shape_2;
_LP0 = _LP0 + (-4507.71544708138) * _9_0;
*** Effect: Gr_Liv_Area;
_LP0 = _LP0 + (42.9721940222406) * Gr_Liv_Area;
*** Effect: Basement_Area;
_LP0 = _LP0 + (25.4912732941362) * Basement_Area;
*** Effect: Garage_Area;
_LP0 = _LP0 + (29.6985561954519) * Garage_Area;
*** Effect: Deck_Porch_Area;
_LP0 = _LP0 + (20.9525612375152) * Deck_Porch_Area;
*** Effect: Lot_Area;
_LP0 = _LP0 + (1.19985759882172) * Lot_Area;
*** Effect: Age_Sold;
_LP0 = _LP0 + (-422.187733226867) * Age_Sold;
*** Effect: Bedroom_AbvGr;
_LP0 = _LP0 + (-4541.1249974614) * Bedroom_AbvGr;
*** Effect: Total_Bathroom;
_LP0 = _LP0 + (3806.35123684251) * Total_Bathroom;

*** Predicted values;
_LP0 = _LP0 +     51206.6225594027;
_SKIP_010:
